...
public class WorkingTimeOnWednesday {
    ...
    public WorkingTimeOnWednesday() {
    }


    public WorkingTimeOnWednesday(String prviderId, String from, String to, String partTimeFrom, String partTimeTo) {
