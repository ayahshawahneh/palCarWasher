...
public class WorkingTimeOnThuresday {
    ...
    public WorkingTimeOnThuresday() {
    }


    public WorkingTimeOnThuresday(String prviderId, String from, String to, String partTimeFrom, String partTimeTo) {
