...
public class WorkingTimeOnSunday {
    ...
    public WorkingTimeOnSunday() {
    }




    public WorkingTimeOnSunday(String prviderId, String from, String to, String partTimeFrom, String partTimeTo) {
