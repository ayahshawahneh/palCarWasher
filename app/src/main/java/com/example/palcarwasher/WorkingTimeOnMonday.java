...
public class WorkingTimeOnMonday {
    ...
    public WorkingTimeOnMonday() {
    }
    public WorkingTimeOnMonday(String prviderId, String from, String to, String partTimeFrom, String partTimeTo) {
