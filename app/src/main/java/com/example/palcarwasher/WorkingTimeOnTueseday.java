...
public class WorkingTimeOnTueseday {
    ...
    public WorkingTimeOnTueseday() {
    }

    public WorkingTimeOnTueseday(String prviderId, String from, String to, String partTimeFrom, String partTimeTo) {
